...
- Make them easy to understand, use simple short sentences, avoid long and complex sentences，if necessary, use comma `,` to split the sentences
- Be familiar with English idioms, such as "throw stuff at the wall" in "no customer interviews, throw stuff at the wall, launch fast" cannot be literally translated as "throw things at the wall," but should be translated as "make bold attempts" or simply "try things out."
- There must be spaces between Chinese and English, as well as between Chinese and numbers
- No need to translate author names and media platforms
