---
name: email-to-chinese-article-readwise-2
...
```bash
bun --env-file .opencode/skills/imap-smtp-email/.env .opencode/skills/email-to-chinese-article/scripts/index.ts [--vol=volNum]
```
...
3. 标题和导读之后，增加一个章节，介绍本文的**1个**观点：
  - 生成之前先列出所有趣发人深省的观点或文章，等我确认后再继续。行文风格参考：[brief-view-of-the-week.md](.opencode\skills\email-to-chinese-article\references\brief-view-of-the-week.md)
  - 字数 800 字以内。
