...
- `--ten-tabs-subject`: 待搜索的 Ten Tabs 邮件主题 (**required**)
...
3. 标题和导读之后，增加一个章节，介绍本文的**1个**观点：
  - 生成之前先列出本期所有趣发人深省的观点或文章，每一个观点需要给出 url 和更多信息，方便我抉择，我确认后再继续。
  - 行文风格参考：[brief-view-of-the-week.md](.opencode/skills/email-to-chinese-article/references/brief-view-of-the-week.md)
  - 字数小于 800。
