...
describe("html to markdown", () => {
  test("extractArticles", async (t) => {
        ...
        subArticles: [
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2Ffab264a9-a34e-48b7-a465-f450ab46b159.jpeg",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2Fb952acfc-e01f-4bb5-ad9e-f5ec834d59ac.jpeg",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2F58d35413-5c03-4f43-b075-e409dfd89579.png",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2Fc3f3fb9c-31bc-460e-8e4d-1d9d7f87447e.jpeg",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2Ff0ec863a-addc-4727-bef2-c17b4ea6ba3a.webp",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2F93b9964b-79a5-4b93-b850-2a1fd3000027.jpeg",
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2Fe4769be0-d6cc-4217-b88d-7d80460b715e.jpeg",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2Fda8e13d5-bd02-4080-813f-aae2bd5b8d91.jpeg",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2F45d72c81-e719-4a21-8448-462f734d7ca5.jpeg",
            summary:
          ...
          },
          {
            ...
            img: "https://pocket-image-cache.com/600x600/filters:format(jpeg):quality(100):no_upscale():strip_exif()/https%3A%2F%2Fs3.us-east-1.amazonaws.com%2Fpocket-curatedcorpusapi-prod-images%2F4c7ff71c-a74f-4dda-a402-a844da03a8c6.jpeg",
    ...
    // articlesToMarkdown
    const markdown = articlesToMarkdown(actual, {
      titleWithUrl: true,
      startIndex: 7,
    })
